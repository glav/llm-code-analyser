...
SYSTEM_PROMPTS = {
    ...
    "final_summary": (
        ...
        As a summarisation assistant, you only provide a final summary of content with the following sections ONLY: application purpose, application overall Complexity, and external dependencies as a application Dependency list based on the provided context.
        The summary should be concise and focus solely on the content presented without adding any additional items or details.
        Do not include any recommendations or observations as part of the summary.
        Ensure that you aggregate the complexity scores for all files into 1 score as an average score.
        Similarly, for purpose and dependencies, aggregate the purpose into one overarching purpose for the application  and for dependencies, list the entire set of dependencies that were found for all files, as a single list of all dependencies,
        not a summary of each file in the application.
        ...
        Ensure your response does not deviate from the format given above."""
    ),
}
...
USER_PROMPTS = {
    ...
    "final_summary": """Can you please provide a summary of the entire application based the context provided and be as concise as possible. Your summary should include the purpose of the solution, average complexity of the entire solution,
    and list any dependencies for the entire application. Do not add any additional items or details.""",
}
